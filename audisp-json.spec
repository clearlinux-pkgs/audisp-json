...
Version  : 2.2.0
Release  : 1
URL      : https://github.com/gdestuynder/audisp-json/archive/2.2.0.tar.gz
Source0  : https://github.com/gdestuynder/audisp-json/archive/2.2.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1547179504
make  %{?_smp_mflags}
