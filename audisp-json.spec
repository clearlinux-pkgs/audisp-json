...
Version  : 2.2.5
Release  : 8
URL      : https://github.com/gdestuynder/audisp-json/archive/2.2.5/audisp-json-2.2.5.tar.gz
Source0  : https://github.com/gdestuynder/audisp-json/archive/2.2.5/audisp-json-2.2.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1555165587
make  %{?_smp_mflags}
